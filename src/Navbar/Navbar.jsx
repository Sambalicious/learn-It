...
const Navbar = () => {
  ...
  <div className="flex items-center flex-shrink-0 mr-6 text-white">
    ...
    <span className="text-xl font-bold">Learn-It</span>
  </div>
  ...
  <div className="flex-grow block w-full lg:flex lg:items-center lg:w-auto">
    <div className="text-sm lg:flex-grow">
      <Link to="/special-offer" className="block mt-4 mr-4 text-teal-200 lg:inline-block lg:mt-0 hover:text-white">
        Become an instructor
      </Link>
      <Link to="/student" className="block mt-4 mr-4 text-teal-200 lg:inline-block lg:mt-0 hover:text-white">
        Learn with us
      </Link>
      <Link to="/dashboard" className="block mt-4 mr-4 text-teal-200 lg:inline-block lg:mt-0 hover:text-white">
        Dashboard
      </Link>
      <Link to="/help" className="block mt-4 text-teal-200 lg:inline-block lg:mt-0 hover:text-white">
          Courses
      </Link>
    </div>
    <div>
