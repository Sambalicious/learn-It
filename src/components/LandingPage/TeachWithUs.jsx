...
const TeachWithUs = () => {
    return ( 
       ...
       <div>
            <div className="container px-4 mb-4 transition duration-500 ease-in-out transform shadow sm:shadow-md xl:shadow-2xl md:m-16 xl:m-20 hover:-translate-y-1 hover:scale-103">
            <div className="justify-between md:flex md:m-6 lg:wrap sm:p-10">
      <div className="md:mt-4 md:mr-16 md:mt-0 md:ml-6">
         <div className="my-4 text-sm font-bold tracking-wide text-indigo-600 uppercase sm:pt-4 sm:mt-2">Teach on Learn-It</div>
