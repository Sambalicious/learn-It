...
const TeachWithUs = () => {
    return ( 
       ...
       <div>
            <div className="container p-2 mx-4 my-5 transition duration-500 ease-in-out transform shadow sm:shadow-md xl:shadow-2xl hover:-translate-y-1 hover:scale-103">
